...
describe("Test scanning text", () => {
  const tests = [
    ...
    },
    {
      ...
      input: "1 + 2 - 3 * 4 / 5 % 6 ^ 7 DIV 8",
      expected: [
        new Token(0, "NUMBER", "1", 1),
        new Token(2, "PLUS", "+"),
        new Token(4, "NUMBER", "2", 2),
        new Token(6, "MINUS", "-"),
        new Token(8, "NUMBER", "3", 3),
        new Token(10, "STAR", "*"),
        new Token(12, "NUMBER", "4", 4),
        new Token(14, "SLASH", "/"),
        new Token(16, "NUMBER", "5", 5),
        new Token(18, "PERCENT", "%"),
        new Token(20, "NUMBER", "6", 6),
        new Token(22, "CARET", "^"),
        new Token(24, "NUMBER", "7", 7),
        new Token(26, "DIV", "DIV"),
        new Token(30, "NUMBER", "8", 8),
        new Token(31, "EOF", ""),
      ],
    },
    {
      name: "arithmetic precedence with nested exponentiation",
      input: "2 ^ (3 ^ 4)",
      expected: [
        new Token(0, "NUMBER", "2", 2),
        new Token(2, "CARET", "^"),
        new Token(4, "LEFT_PAREN", "("),
        new Token(5, "NUMBER", "3", 3),
        new Token(7, "CARET", "^"),
        new Token(9, "NUMBER", "4", 4),
        new Token(10, "RIGHT_PAREN", ")"),
        new Token(11, "EOF", ""),
      ],
    },
    {
      name: "arithmetic precedence with mixed operators",
      input: "(2 DIV 3) * (4 ^ 2) % 5",
      expected: [
        new Token(0, "LEFT_PAREN", "("),
        new Token(1, "NUMBER", "2", 2),
        new Token(3, "DIV", "DIV"),
        new Token(7, "NUMBER", "3", 3),
        new Token(8, "RIGHT_PAREN", ")"),
        new Token(10, "STAR", "*"),
        new Token(12, "LEFT_PAREN", "("),
        new Token(13, "NUMBER", "4", 4),
        new Token(15, "CARET", "^"),
        new Token(17, "NUMBER", "2", 2),
        new Token(18, "RIGHT_PAREN", ")"),
        new Token(20, "PERCENT", "%"),
        new Token(22, "NUMBER", "5", 5),
        new Token(23, "EOF", ""),
      ],
    },
    {
      ...
      expected: [
        new Token(0, "TRUE", "true", true),
        new Token(5, "FALSE", "false", false),
        new Token(11, "TRUE", "True", true),
        new Token(16, "FALSE", "False", false),
    ...
    },
    {
      ...
      input:
        "(NOT (name>'København') AND pop_other<>1038288) OR (name<='København' and boolean=true) or not (pop_other<>1038288 OR boolean =true)",
      expected: [
        new Token(0, "LEFT_PAREN", "("),
        new Token(1, "NOT", "NOT"),
        new Token(5, "LEFT_PAREN", "("),
        new Token(6, "IDENTIFIER", "name"),
        new Token(10, "GREATER", ">"),
        new Token(11, "STRING", "'København'", "København"),
        new Token(22, "RIGHT_PAREN", ")"),
        new Token(24, "AND", "AND"),
        new Token(28, "IDENTIFIER", "pop_other"),
        new Token(37, "NOT_EQUAL", "<>"),
        new Token(39, "NUMBER", "1038288", 1038288),
        new Token(46, "RIGHT_PAREN", ")"),
        new Token(48, "OR", "OR"),
        new Token(51, "LEFT_PAREN", "("),
        new Token(52, "IDENTIFIER", "name"),
        new Token(56, "LESS_EQUAL", "<="),
        new Token(58, "STRING", "'København'", "København"),
        new Token(70, "AND", "and"),
        new Token(74, "IDENTIFIER", "boolean"),
        new Token(81, "EQUAL", "="),
        new Token(82, "TRUE", "true", true),
        new Token(86, "RIGHT_PAREN", ")"),
        new Token(88, "OR", "or"),
        new Token(91, "NOT", "not"),
        new Token(95, "LEFT_PAREN", "("),
        new Token(96, "IDENTIFIER", "pop_other"),
        new Token(105, "NOT_EQUAL", "<>"),
        new Token(107, "NUMBER", "1038288", 1038288),
        new Token(115, "OR", "OR"),
        new Token(118, "IDENTIFIER", "boolean"),
        new Token(126, "EQUAL", "="),
        new Token(127, "TRUE", "true", true),
        new Token(131, "RIGHT_PAREN", ")"),
        new Token(132, "EOF", ""),
      ],
    },
